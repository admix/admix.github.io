...
+ function(a) {
    ...
    f.prototype.toggle = function(d) {
        ...
        if (!e.is(".disabled, :disabled")) {
            ...
            if (b(), !g) {
                if ("ontouchstart"in document.documentElement&&!f.closest(".navbar-nav").length && a('<div class="dropdown-backdrop"/>').insertAfter(a(this)).on("click", b), f.trigger(d = a.Event("show.bs.dropdown")
